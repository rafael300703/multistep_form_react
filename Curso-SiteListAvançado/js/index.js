...
const updateTodo = (text) => {
    ...
    todos.forEach((todo) => {
        ...
        if(todoTitle.innerText === oldInputValue){
            ...
            upadateTodoLocalStorage(oldInputValue, text)
        }
    })
}
...
document.addEventListener("click", (e) => {
    ...
    const parentEl = targetEl.closest("div");  //elemento pai mais proximo
    let todoTitle;
    ...
    if(targetEl.classList.contains("finish-todo")){
        ...
        upadateTodoStatusLocalStorage(todoTitle)
    }
...
const upadateTodoStatusLocalStorage = (todoText) => {
    const todos = getTodosLocalStorage()
...
const upadateTodoLocalStorage = (todoOldText, todoNewText) => {
    const todos = getTodosLocalStorage()
